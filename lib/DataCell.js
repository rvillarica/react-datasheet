...
var DataCell = function (_PureComponent) {
  ...
  _createClass(DataCell, [{
    ...
    value: function handleCommit(value, e) {
      ...
      //prevent garbage values from being committed to the spreadsheet...
      let vertexObj = null;
      try {
        let tempVertexObj = JSON.parse(value);
        if(tempVertexObj.hasOwnProperty('name') && 
           tempVertexObj.hasOwnProperty('value')) {
          if (tempVertexObj.name.trim() !== "") {
            vertexObj = tempVertexObj;
          }
        }
      }
      catch(err) {}

      if (value !== initialData(this.props) && vertexObj !== null) {
    ...
    value: function handleKey(e) {
      ...
      var _props6 = this.props,
          ...
          dataEditor = _props6.cell.dataEditor;

      var eatKeys = forceEdit || !!component || !!dataEditor;
    ...
    value: function renderViewer(cell, row, col, valueRenderer, valueViewer) {
      ...
      return _react2.default.createElement(Viewer, { cell: cell, row: row, col: col, value: value, setDragging: this.props.setDragging});
    }
  }, {
    key: 'render',
